...
- Через sing-box проходит весь TCP/UDP-трафик с настроенных интерфейсов (а не только пакеты с FakeIP-адресами), поэтому нагрузка на CPU роутера выше. На современных моделях (MT7981/Filogic 880, MT7986) это незаметно.
